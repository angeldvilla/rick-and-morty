...
const Card = ({id, name, status, species, origin, gender, image, onClose, addFavorites, removeFavorites, removeFavoriteCharacter}) => 
{
   ...
   const handleFavorite = () => {
      if(isFav) {
         ...
         setisFav(true)
         addFavorites({id, name, status, species, origin, gender, image})
      }
   }
