...
function App() {
  ...
  const showErrorLogin = () => {
    swal({
      title: "Incorrect Credentials, Try Again!",
      icon: "error",
      customClass: {
        container: "my-swal",
      },
        ...
        <div className={styles.blurIn}>
          ...
          {(location.pathname === '/' || location.pathname !== '/home' ||
            ...
            location.pathname !== '/about') && (
              <button className={styles.randomChar} onClick={randomCharacter}>
                RANDOM CHAR
                <img src='https://www.comoaprenderdesenhar.com.br/wp-content/uploads/2020/10/como-desenhar-morty.png' style={{ width: '1.1em', height: '0.9em', marginRight: '-0.1em', marginLeft: '0.3em' }} alt="Random Character" />
              </button>
            )}
        </div>
        <Routes>
